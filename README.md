...
- **AM / FM**
  - FM: 87.5–108.0 MHz, шаг 0.1, кубический спад дальности
  - AM: 530–1600 kHz, шаг 10, дальность ×3, линейный спад
- Неточная настройка даёт сигнал с сильными помехами
- Белый шум (`real_radio:radio_static`) громче при плохом качестве сигнала
- GUI в стиле старого радио (частота, мощность/громкость, AM/FM, питание)
