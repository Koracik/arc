...
- **AM / FM**
  - FM: 87.5–108.0 MHz, шаг 0.1, дальность ~100–180 блоков (авто, ниже частота — дальше)
  - AM: 530–1600 kHz, шаг 10, дальность ~280–520 блоков (авто), линейный спад
- Дальность **не выбирается игроком** — зависит от частоты, как в реальности
